package com.notaria.infraestructure.entrypoint.rest.advice;

import com.notaria.domain.exception.DomainException;
...
import com.notaria.infrastructure.adapter.persistence.exception.PersistenceException;
...
public class GlobalExceptionHandler {
    ...
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public ApiErrorResponse handleMethodArgumentNotValid(final MethodArgumentNotValidException exception) {
